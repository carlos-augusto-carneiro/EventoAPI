...
public sealed class ListarUserEventoMap : Profile
{
    public ListarUserEventoMap()
    {
        CreateMap<ListarUserEventoRequest, Usuario>();
        CreateMap<Usuario, ListarUserEventoResponse>();
    }
}
